...
namespace Gov.Jag.Spice.Interfaces
{
    ...
    public static partial class ExportrequestincidentsetExtensions
    {
            ...
            /// </param>
            public static HttpOperationResponse<ExportrequestincidentsetGetResponseModel> GetWithHttpMessages(this IExportrequestincidentset operations, int? top = default(int?), int? skip = default(int?), string search = default(string), string filter = default(string), bool? count = default(bool?), IList<string> orderby = default(IList<string>), IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), Dictionary<string, List<string>> customHeaders = null)
            {
