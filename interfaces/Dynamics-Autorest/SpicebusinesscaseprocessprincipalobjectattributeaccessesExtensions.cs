...
namespace Gov.Jag.Spice.Interfaces
{
    ...
    /// <summary>
    /// Extension methods for Spicebusinesscaseprocessprincipalobjectattributeaccesses.
    /// </summary>
    public static partial class SpicebusinesscaseprocessprincipalobjectattributeaccessesExtensions
    {
            /// <summary>
            /// Get spice_spice_businesscaseprocess_PrincipalObjectAttributeAccesses from
            ...
            /// </param>
            public static async Task<MicrosoftDynamicsCRMprincipalobjectattributeaccessCollection> GetAsync(this ISpicebusinesscaseprocessprincipalobjectattributeaccesses operations, string businessprocessflowinstanceid, int? top = default(int?), int? skip = default(int?), string search = default(string), string filter = default(string), bool? count = default(bool?), IList<string> orderby = default(IList<string>), IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// Expand related entities
            /// </param>
            public static MicrosoftDynamicsCRMprincipalobjectattributeaccess PrincipalObjectAttributeAccessesByKey(this ISpicebusinesscaseprocessprincipalobjectattributeaccesses operations, string businessprocessflowinstanceid, string principalobjectattributeaccessid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<MicrosoftDynamicsCRMprincipalobjectattributeaccess> PrincipalObjectAttributeAccessesByKeyAsync(this ISpicebusinesscaseprocessprincipalobjectattributeaccesses operations, string businessprocessflowinstanceid, string principalobjectattributeaccessid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// Headers that will be added to request.
            /// </param>
            public static HttpOperationResponse<MicrosoftDynamicsCRMprincipalobjectattributeaccess> PrincipalObjectAttributeAccessesByKeyWithHttpMessages(this ISpicebusinesscaseprocessprincipalobjectattributeaccesses operations, string businessprocessflowinstanceid, string principalobjectattributeaccessid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), Dictionary<string, List<string>> customHeaders = null)
            {
