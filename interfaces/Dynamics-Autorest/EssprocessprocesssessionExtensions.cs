...
namespace Gov.Jag.Spice.Interfaces
{
    ...
    /// <summary>
    /// Extension methods for Essprocessprocesssession.
    /// </summary>
    public static partial class EssprocessprocesssessionExtensions
    {
            /// <summary>
            /// Get spice_essprocess_ProcessSession from spice_essprocesses
            /// </summary>
            ...
            /// </param>
            public static async Task<MicrosoftDynamicsCRMprocesssessionCollection> GetAsync(this IEssprocessprocesssession operations, string businessprocessflowinstanceid, int? top = default(int?), int? skip = default(int?), string search = default(string), string filter = default(string), bool? count = default(bool?), IList<string> orderby = default(IList<string>), IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// Expand related entities
            /// </param>
            public static MicrosoftDynamicsCRMprocesssession ProcessSessionByKey(this IEssprocessprocesssession operations, string businessprocessflowinstanceid, string processsessionid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>))
            {
