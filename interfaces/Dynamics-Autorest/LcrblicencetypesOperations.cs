...
namespace Gov.Jag.Spice.Interfaces
{
    ...
    /// <summary>
    /// LcrblicencetypesOperations operations.
    /// </summary>
    internal partial class LcrblicencetypesOperations : IServiceOperations<DynamicsClient>, ILcrblicencetypesOperations
    {
        /// <summary>
        /// Initializes a new instance of the LcrblicencetypesOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal LcrblicencetypesOperations(DynamicsClient client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse<LcrblicencetypesGetResponseModel>> GetWithHttpMessagesAsync(int? top = default(int?), int? skip = default(int?), string search = default(string), string filter = default(string), bool? count = default(bool?), IList<string> orderby = default(IList<string>), IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Tracing
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "spice_lcrblicencetypes").ToString();
            ...
            // Create Result
            var _result = new AzureOperationResponse<LcrblicencetypesGetResponseModel>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Microsoft.Rest.Serialization.SafeJsonConvert.DeserializeObject<LcrblicencetypesGetResponseModel>(_responseContent, Client.DeserializationSettings);
                }
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<MicrosoftDynamicsCRMspiceLcrblicencetype>> CreateWithHttpMessagesAsync(MicrosoftDynamicsCRMspiceLcrblicencetype body, string prefer = "return=representation", Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (body == null)
            {
            ...
            // Create Result
            var _result = new AzureOperationResponse<MicrosoftDynamicsCRMspiceLcrblicencetype>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            if (_httpResponse.Headers.Contains("x-ms-request-id"))
            {
        ...
        public async Task<AzureOperationResponse<MicrosoftDynamicsCRMspiceLcrblicencetype>> GetByKeyWithHttpMessagesAsync(string spiceLcrblicencetypeid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Construct URL
            var _baseUrl = Client.BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "spice_lcrblicencetypes({spice_lcrblicencetypeid})").ToString();
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse> DeleteWithHttpMessagesAsync(string spiceLcrblicencetypeid, string ifMatch = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (spiceLcrblicencetypeid == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "spiceLcrblicencetypeid");
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse> UpdateWithHttpMessagesAsync(string spiceLcrblicencetypeid, MicrosoftDynamicsCRMspiceLcrblicencetype body, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (spiceLcrblicencetypeid == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "spiceLcrblicencetypeid");
