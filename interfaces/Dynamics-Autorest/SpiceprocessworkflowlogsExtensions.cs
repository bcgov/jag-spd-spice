...
namespace Gov.Jag.Spice.Interfaces
{
    ...
    /// <summary>
    /// Extension methods for Spiceprocessworkflowlogs.
    /// </summary>
    public static partial class SpiceprocessworkflowlogsExtensions
    {
            /// <summary>
            /// Get spice_spiceprocess_WorkflowLogs from spice_spiceprocesses
            /// </summary>
            ...
            /// </param>
            public static async Task<MicrosoftDynamicsCRMworkflowlogCollection> GetAsync(this ISpiceprocessworkflowlogs operations, string businessprocessflowinstanceid, int? top = default(int?), int? skip = default(int?), string search = default(string), string filter = default(string), bool? count = default(bool?), IList<string> orderby = default(IList<string>), IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// </param>
            public static HttpOperationResponse<MicrosoftDynamicsCRMworkflowlogCollection> GetWithHttpMessages(this ISpiceprocessworkflowlogs operations, string businessprocessflowinstanceid, int? top = default(int?), int? skip = default(int?), string search = default(string), string filter = default(string), bool? count = default(bool?), IList<string> orderby = default(IList<string>), IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), Dictionary<string, List<string>> customHeaders = null)
            {
            ...
            /// Expand related entities
            /// </param>
            public static MicrosoftDynamicsCRMworkflowlog WorkflowLogsByKey(this ISpiceprocessworkflowlogs operations, string businessprocessflowinstanceid, string workflowlogid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<MicrosoftDynamicsCRMworkflowlog> WorkflowLogsByKeyAsync(this ISpiceprocessworkflowlogs operations, string businessprocessflowinstanceid, string workflowlogid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), CancellationToken cancellationToken = default(CancellationToken))
            {
