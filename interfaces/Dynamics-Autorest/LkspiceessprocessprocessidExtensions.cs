...
namespace Gov.Jag.Spice.Interfaces
{
    ...
    /// <summary>
    /// Extension methods for Lkspiceessprocessprocessid.
    /// </summary>
    public static partial class LkspiceessprocessprocessidExtensions
    {
            /// <summary>
            ...
            /// </param>
            public static MicrosoftDynamicsCRMspiceEssprocessCollection Get(this ILkspiceessprocessprocessid operations, string workflowid, int? top = default(int?), int? skip = default(int?), string search = default(string), string filter = default(string), bool? count = default(bool?), IList<string> orderby = default(IList<string>), IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>))
            {
            ...
            /// </param>
            public static async Task<MicrosoftDynamicsCRMspiceEssprocessCollection> GetAsync(this ILkspiceessprocessprocessid operations, string workflowid, int? top = default(int?), int? skip = default(int?), string search = default(string), string filter = default(string), bool? count = default(bool?), IList<string> orderby = default(IList<string>), IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// Expand related entities
            /// </param>
            public static MicrosoftDynamicsCRMspiceEssprocess ProcessidByKey(this ILkspiceessprocessprocessid operations, string workflowid, string businessprocessflowinstanceid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<MicrosoftDynamicsCRMspiceEssprocess> ProcessidByKeyAsync(this ILkspiceessprocessprocessid operations, string workflowid, string businessprocessflowinstanceid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// Headers that will be added to request.
            /// </param>
            public static HttpOperationResponse<MicrosoftDynamicsCRMspiceEssprocess> ProcessidByKeyWithHttpMessages(this ILkspiceessprocessprocessid operations, string workflowid, string businessprocessflowinstanceid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), Dictionary<string, List<string>> customHeaders = null)
            {
