...
namespace Gov.Jag.Spice.Interfaces.Models
{
    ...
    /// </summary>
    public partial class MicrosoftDynamicsCRMComplexDateTimeAttributeMetadata
    {
        /// <summary>
        /// Initializes a new instance of the
        /// MicrosoftDynamicsCRMComplexDateTimeAttributeMetadata class.
        /// </summary>
        public MicrosoftDynamicsCRMComplexDateTimeAttributeMetadata()
        {
            CustomInit();
        }
        ...
        public MicrosoftDynamicsCRMComplexDateTimeAttributeMetadata(string format = default(string), string imeMode = default(string), int? sourceTypeMask = default(int?), string formulaDefinition = default(string), MicrosoftDynamicsCRMDateTimeBehavior dateTimeBehavior = default(MicrosoftDynamicsCRMDateTimeBehavior), MicrosoftDynamicsCRMBooleanManagedProperty canChangeDateTimeBehavior = default(MicrosoftDynamicsCRMBooleanManagedProperty))
        {
            Format = format;
            ImeMode = imeMode;
