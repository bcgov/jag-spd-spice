...
namespace Gov.Jag.Spice.Interfaces.Models
{
    ...
    /// </summary>
    public partial class MicrosoftDynamicsCRMComplexMemoAttributeMetadata
    {
        /// <summary>
        /// Initializes a new instance of the
        /// MicrosoftDynamicsCRMComplexMemoAttributeMetadata class.
        /// </summary>
        public MicrosoftDynamicsCRMComplexMemoAttributeMetadata()
        {
            CustomInit();
        }
        ...
        public MicrosoftDynamicsCRMComplexMemoAttributeMetadata(string format = default(string), string imeMode = default(string), int? maxLength = default(int?), bool? isLocalizable = default(bool?))
        {
            Format = format;
            ImeMode = imeMode;
            MaxLength = maxLength;
