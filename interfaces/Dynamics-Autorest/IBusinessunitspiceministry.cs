...
namespace Gov.Jag.Spice.Interfaces
{
    ...
    /// </summary>
    public partial interface IBusinessunitspiceministry
    {
        /// <summary>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<HttpOperationResponse<MicrosoftDynamicsCRMspiceMinistry>> MinistryByKeyWithHttpMessagesAsync(string businessunitid, string spiceMinistryid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
