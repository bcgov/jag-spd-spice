...
namespace Gov.Jag.Spice.Interfaces
{
    ...
    /// <summary>
    /// CompaniesOperations operations.
    /// </summary>
    internal partial class CompaniesOperations : IServiceOperations<DynamicsClient>, ICompaniesOperations
    {
        /// <summary>
        /// Initializes a new instance of the CompaniesOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal CompaniesOperations(DynamicsClient client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse<CompaniesGetResponseModel>> GetWithHttpMessagesAsync(int? top = default(int?), int? skip = default(int?), string search = default(string), string filter = default(string), bool? count = default(bool?), IList<string> orderby = default(IList<string>), IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Tracing
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "spice_companies").ToString();
            ...
            // Create Result
            var _result = new AzureOperationResponse<CompaniesGetResponseModel>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Microsoft.Rest.Serialization.SafeJsonConvert.DeserializeObject<CompaniesGetResponseModel>(_responseContent, Client.DeserializationSettings);
                }
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<MicrosoftDynamicsCRMspiceCompany>> CreateWithHttpMessagesAsync(MicrosoftDynamicsCRMspiceCompany body, string prefer = "return=representation", Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (body == null)
            {
            ...
            // Create Result
            var _result = new AzureOperationResponse<MicrosoftDynamicsCRMspiceCompany>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            if (_httpResponse.Headers.Contains("x-ms-request-id"))
            {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<MicrosoftDynamicsCRMspiceCompany>> GetByKeyWithHttpMessagesAsync(string spiceCompanyid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Construct URL
            var _baseUrl = Client.BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "spice_companies({spice_companyid})").ToString();
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse> DeleteWithHttpMessagesAsync(string spiceCompanyid, string ifMatch = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (spiceCompanyid == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "spiceCompanyid");
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse> UpdateWithHttpMessagesAsync(string spiceCompanyid, MicrosoftDynamicsCRMspiceCompany body, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (spiceCompanyid == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "spiceCompanyid");
