...
namespace Gov.Jag.Spice.Interfaces
{
    ...
    /// <summary>
    /// Extension methods for Lkspicespicebusinesscaseprocessactivestageid.
    /// </summary>
    public static partial class LkspicespicebusinesscaseprocessactivestageidExtensions
    {
            /// <summary>
            ...
            /// </param>
            public static async Task<MicrosoftDynamicsCRMspiceSpiceBusinesscaseprocessCollection> GetAsync(this ILkspicespicebusinesscaseprocessactivestageid operations, string processstageid, int? top = default(int?), int? skip = default(int?), string search = default(string), string filter = default(string), bool? count = default(bool?), IList<string> orderby = default(IList<string>), IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// Expand related entities
            /// </param>
            public static MicrosoftDynamicsCRMspiceSpiceBusinesscaseprocess ActivestageidByKey(this ILkspicespicebusinesscaseprocessactivestageid operations, string processstageid, string businessprocessflowinstanceid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<MicrosoftDynamicsCRMspiceSpiceBusinesscaseprocess> ActivestageidByKeyAsync(this ILkspicespicebusinesscaseprocessactivestageid operations, string processstageid, string businessprocessflowinstanceid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// Headers that will be added to request.
            /// </param>
            public static HttpOperationResponse<MicrosoftDynamicsCRMspiceSpiceBusinesscaseprocess> ActivestageidByKeyWithHttpMessages(this ILkspicespicebusinesscaseprocessactivestageid operations, string processstageid, string businessprocessflowinstanceid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), Dictionary<string, List<string>> customHeaders = null)
            {
