...
namespace Gov.Jag.Spice.Interfaces
{
    ...
    /// </summary>
    public partial interface IServiceses
    {
        /// <summary>
        ...
        /// </exception>
        Task<HttpOperationResponse<MicrosoftDynamicsCRMspiceServices>> CreateWithHttpMessagesAsync(MicrosoftDynamicsCRMspiceServices body, string prefer = "return=representation", Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
