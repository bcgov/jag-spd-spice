...
namespace Gov.Jag.Spice.Interfaces
{
    ...
    /// <summary>
    /// Extension methods for Companytasks.
    /// </summary>
    public static partial class CompanytasksExtensions
    {
            /// <summary>
            ...
            /// </param>
            public static MicrosoftDynamicsCRMtaskCollection Get(this ICompanytasks operations, string spiceCompanyid, int? top = default(int?), int? skip = default(int?), string search = default(string), string filter = default(string), bool? count = default(bool?), IList<string> orderby = default(IList<string>), IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>))
            {
            ...
            /// </param>
            public static async Task<MicrosoftDynamicsCRMtaskCollection> GetAsync(this ICompanytasks operations, string spiceCompanyid, int? top = default(int?), int? skip = default(int?), string search = default(string), string filter = default(string), bool? count = default(bool?), IList<string> orderby = default(IList<string>), IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// </param>
            public static HttpOperationResponse<MicrosoftDynamicsCRMtaskCollection> GetWithHttpMessages(this ICompanytasks operations, string spiceCompanyid, int? top = default(int?), int? skip = default(int?), string search = default(string), string filter = default(string), bool? count = default(bool?), IList<string> orderby = default(IList<string>), IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), Dictionary<string, List<string>> customHeaders = null)
            {
            ...
            /// Expand related entities
            /// </param>
            public static MicrosoftDynamicsCRMtask TasksByKey(this ICompanytasks operations, string spiceCompanyid, string activityid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>))
            {
                return operations.TasksByKeyAsync(spiceCompanyid, activityid, select, expand).GetAwaiter().GetResult();
            }
