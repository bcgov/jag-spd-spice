...
namespace Gov.Jag.Spice.Interfaces
{
    ...
    /// <summary>
    /// Extension methods for Lkspicespicebusinesscaseprocessmodifiedby.
    /// </summary>
    public static partial class LkspicespicebusinesscaseprocessmodifiedbyExtensions
    {
            /// <summary>
            ...
            /// </param>
            public static async Task<MicrosoftDynamicsCRMspiceSpiceBusinesscaseprocessCollection> GetAsync(this ILkspicespicebusinesscaseprocessmodifiedby operations, string ownerid, int? top = default(int?), int? skip = default(int?), string search = default(string), string filter = default(string), bool? count = default(bool?), IList<string> orderby = default(IList<string>), IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// Expand related entities
            /// </param>
            public static MicrosoftDynamicsCRMspiceSpiceBusinesscaseprocess ModifiedbyByKey(this ILkspicespicebusinesscaseprocessmodifiedby operations, string ownerid, string businessprocessflowinstanceid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<MicrosoftDynamicsCRMspiceSpiceBusinesscaseprocess> ModifiedbyByKeyAsync(this ILkspicespicebusinesscaseprocessmodifiedby operations, string ownerid, string businessprocessflowinstanceid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// Headers that will be added to request.
            /// </param>
            public static HttpOperationResponse<MicrosoftDynamicsCRMspiceSpiceBusinesscaseprocess> ModifiedbyByKeyWithHttpMessages(this ILkspicespicebusinesscaseprocessmodifiedby operations, string ownerid, string businessprocessflowinstanceid, IList<string> select = default(IList<string>), IList<string> expand = default(IList<string>), Dictionary<string, List<string>> customHeaders = null)
            {
