...
namespace SpiceCarlaSync
{
    public sealed class CsvAssociateExportMap : ClassMap<CsvAssociateExport>
    {
        public CsvAssociateExportMap()
        {
            ...
            Map(m => m.Alias2surname).Name("ALIAS LAST 2").Index(21);
            Map(m => m.Alias2firstname).Name("ALIAS FIRST 2").Index(22);
            Map(m => m.Alias2middlename).Name("ALIAS MIDDLE 2").Index(23);
            Map(m => m.Alias3surname).Name("ALIAS LAST 3").Index(24);
            Map(m => m.Alias3firstname).Name("ALIAS FIRST 3").Index(25);
            Map(m => m.Alias3middlename).Name("ALIAS MIDDLE 3").Index(26);
            Map(m => m.Alias4surname).Name("ALIAS LAST 4").Index(27);
